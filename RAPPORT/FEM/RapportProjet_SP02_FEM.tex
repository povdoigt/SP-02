...
\title{
    \Huge \textbf{SP - 02 / Etude FEM} \\
    \large Fusée bi-étage AéroIPSA 2025-2026 \\
    \large Résistance mécanique du système de séparation \\
}
...
\def\@maketitle{
    ...
    \begin{figure}[h]
        \centering
        \rotatebox{-75}{
            \includegraphics[width=1.05\textwidth]{figures/SP_Finish.png}
    ...
    \begin{tabular}{>{\raggedright\arraybackslash}m{0.5\textwidth}
        ...
        \hspace{1cm} - LE CAM Maxens    & Janvier 2026 \\
        \hline
    \end{tabular}
}
\makeatother
...
\fancyhead[R]{Projet SP-02 - Etude CFD}
...
\input{sections/sec1_methodo.tex}
\input{sections/sec2_resultats.tex}
