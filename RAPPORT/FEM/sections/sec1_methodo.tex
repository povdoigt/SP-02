\section{Etudes structurelles par la méthode des éléments finis (\acrshort{FEM})}
...
\subsection{Utilisation de Patran-Nastran}
...
\subsection{Protocole de calcul analytique}
...
\subsection{Définition des paramètres d'étude}
...
% \section{Validation des pièces concues (contraintes du cahier des charges)}
