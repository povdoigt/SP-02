...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
        ...
        \node at (0, 0) {\includegraphics[width=\textwidth]{figures/meca/catia_alpha1.png}};
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
        ...
        \node at (0, 0) {\includegraphics[width=\textwidth]{figures/meca/catia_beta.png}};
...
\begin{figure}[h]
    \centering
    \rotatebox{15}{
        \includegraphics[width=0.21\textwidth]{figures/meca/catia_alpha_beta_narval.png}
    }
