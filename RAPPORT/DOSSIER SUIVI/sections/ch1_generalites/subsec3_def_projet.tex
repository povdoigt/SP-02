...
\begin{itemize}
    \item Hauteur : 1217 mm
    \item Diamètre interne : 80 mm
    \item Epaisseur de paroi : 2 mm
    \item Masse à vide : 3010 g
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
        ...
        \draw[red, ->, line width=1.5] (bloc_sepa_lbl.south)    -- (+7.50, +0.60);
...
\begin{itemize}
    \item Hauteur totale : 2290 mm
    \item Diamètre externe : 104 mm
    \item Masse à vide : 7900 g
    \item Centre de masse : 1295 mm
\end{itemize}

\begin{figure}[h]
    \centering
    \rotatebox{160}{
        \includegraphics[width=0.23\textwidth]{figures/meca/SP_MaJ_1.png}
    }
