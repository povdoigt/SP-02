...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
        ...
        \node at (0, 0) {\includegraphics[width=\textwidth-0.75cm]{figures/catia_alpha1.png}};
        ...
        \draw[red, ->, line width=1.5] (bloc_elec_lbl.south)  -- (-5.50, +0.00);
        \draw[red, ->, line width=1.5] (bloc_sepa_lbl.north)  -- (-6.5, +0.00);
...
\begin{itemize}
    \item Hauteur : 1225 mm
    \item Diamètre interne : 80 mm
    \item Epaisseur de paroi : 2 mm
    \item Masse à vide : 3132 g
    \item Propulseur : Cesaroni G150 - Pro24-3G (compatible avec Pandora)
\end{itemize}
\begin{figure}[h]
    \centering
    \begin{tikzpicture}
    
        \node at (0, 0) {\includegraphics[width=\textwidth-1cm]{figures/catia_beta1.png}};
        
        \node (bloc_sepa_lbl)   at (+8.00, +2.3) {\textbf{Interface de séparation}};
        \node (propu_lbl)       at (+4.30, +2.3) {\textbf{Pro24-3G/6G}};
        \node (bague_propu_lbl) at (+2.60, +1.5) {\textbf{bague de centrage}};
        \node (aileron_lbl)     at (+2.00, -1.5) {\textbf{Ailerons (x4)}};
        \node (bloc_elec_lbl)   at (+0.50, +2.3) {\textbf{Bloc électronique}};
        \node (bloc_para_lbl)   at (-2.00, +1.5) {\textbf{Bloc parachute}};
        \node (coiffe_lbl)      at (-5.00, +2.1) {\textbf{Coiffe conique}};
        \node (pointe_alu_lbl)  at (-6.00, -1.5) {\textbf{Pointe aluminium}};

        \draw[red, ->, line width=1.5] (bloc_sepa_lbl.south)    -- (+7.08, +0.50);
        \draw[red, ->, line width=1.5] (propu_lbl.south)        -- (+5.90, +0.00);
        \draw[red, ->, line width=1.5] (bague_propu_lbl.south)  -- (+5.00, +0.00);
        \draw[red, ->, line width=1.5] (aileron_lbl.east)       -- (+6.50, -1.00);
        \draw[red, ->, line width=1.5] (bloc_elec_lbl.south)    -- (+1.95, +0.00);
        \draw[red, ->, line width=1.5] (bloc_para_lbl.south)    -- (-2.50, +0.00);
        \draw[red, ->, line width=1.5] (coiffe_lbl.south)       -- (-5.30, +0.00);
        \draw[red, ->, line width=1.5] (pointe_alu_lbl.north)   -- (-7.00, +0.00);
...
\begin{itemize}
    \item Hauteur totale : 2225 mm
    \item Diamètre externe : 104 mm
    \item Masse à vide : 7473 g
\end{itemize}

\begin{figure}[h]
    \centering
    \rotatebox{15}{
        \includegraphics[width=0.15\textwidth]{figures/catia_alpha_beta_narval.png}
    }
