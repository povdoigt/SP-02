...
étage via des capteurs barométriques. Les séquenceurs des deux étages sont les mêmes modèles, mais configurés différemment selon
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
        ...
        \node (bloc_elec_lbl)   at (-2.00, +1.5) {\textbf{Bloc électroniques}};
...
\begin{figure}[h]
    \centering
    \rotatebox{-75}{
        \includegraphics[width=1.1\textwidth]{figures/catia_alpha_beta.png}
    }
