\subsection{Séquenceurs et Interface Homme Fusée}
...
Ceux de la carte \acrshort{IHF} sont orientés vers l'extérieur de la fusée pour permettre à cette dernière d'être accessible
depuis l'extérieur de la fusée.
...
\subsubsection{Interface Homme Fusée}

\newpage

\subsubsection{Programme logiciel embarqué}

\subsubsubsection{Contrôle des actionneurs}

\subsubsubsection{Séquenceur au sol}

\newpage

\subsubsubsection{Séquence événementielle de vol}
...
\subsubsubsection{Mesure d'attitude}
