...
\begin{minipage}{0.3\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figures/elec/Sts3215.png}
...
\begin{minipage}{0.65\textwidth}
    ...
    La communication s’effectue via une interface numérique de type \acrshort{UART} half-duplex basée sur des registres internes,
    les servomoteurs étant adressables et pouvant ainsi être chaînés sur une même ligne de communication.
\end{minipage}
