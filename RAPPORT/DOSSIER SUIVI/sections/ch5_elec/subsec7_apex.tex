...
\subsubsubsection{Mesure de la vitesse aérodynamique}
...
\hfill
\begin{minipage}{0.65\textwidth}
    La technique de mesure de la vitesse aérodynamique utilisée par le module expérimental est la technique dite de la sonde
...
\begin{figure}[!ht]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=\textwidth]{figures/meca/Assemblage_pitot_pointe.png}
        \caption{Assemblage de la PCB pitot sur le support de la pointe}
        \label{fig:vue_pointe1}
    \end{subfigure}
    \hfill% Espace horizontal entre les deux sous-figures
    \begin{subfigure}[b]{0.4\textwidth}
        \includegraphics[width=\textwidth]{figures/sp02_controle91.png} % Remplace par ton deuxième fichier
        \caption{Vue externe de la pointe montée}
        \label{fig:vue_pointe2}
    \end{subfigure}
    \caption{Légende globale pour les deux images (optionnelle).}
    \label{fig:vue_pitot}
\end{figure}
\vfill
