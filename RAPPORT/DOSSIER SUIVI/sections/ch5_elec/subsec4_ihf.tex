...
dimension du trou dans la peau de la fusée et ainsi limiter les perturbations aérodynamiques et la résistance structurelle
globale, mais également être la plus complète possible pour permettre de piloter l'ensemble des actions de la fusée.\\
...
\begin{minipage}{0.70\textwidth}
    \centering
    \begin{tikzpicture}
        \node at (0, 0) {\includegraphics[width=0.45\textwidth]{figures/elec/PCB_IHF.jpg}};
...
[ METTRE PHOTO IHF SUR SEQUENCEUR + PHOTO IHF DANS FUSEE]
