...
\begin{minipage}{0.40\textwidth}
    \begin{figure}[H]
        ...
        \caption{Zoom sur le synoptique de la ligne de mise à feu (ref. annexe \ref{subsec:synoptique_fusee})}
    \end{figure}
\end{minipage}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{figures/elec/SP02_Alumage_sinopsis.drawio.pdf}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.45\textwidth]{figures/elec/SP02_Alumage_sinopsis_charge_zoom.drawio.pdf}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.45\textwidth]{figures/elec/SP02_Alumage_sinopsis_condo_zoom.drawio.pdf}
...
\begin{minipage}{0.45\textwidth}
    ...
    Puis, deux optocoupleurs et de deux transistors \acrshort{MOSFET} jouent le rôle respectivement de commutateur à haut
...
\begin{minipage}{0.45\textwidth}
    \begin{figure}[H]
        \centering
        \includegraphics[width=\textwidth]{figures/elec/SP02_Alumage_sinopsis_iso_zoom.drawio.pdf}
...
\begin{minipage}{0.4\textwidth}
    \begin{figure}[H]
        \centering
        \includegraphics[width=\textwidth]{figures/elec/SP02_Alumage_sinopsis_end_zoom.drawio.pdf}
...
\begin{enumerate}[resume]
    ...
    \item Vérifier que la led \verb|CONDO| est allumée en \textcolor{red}{rouge}.
    \item Vérifier que la led \verb|SEQ| est éteinte et que le buzzer est éteint.
\end{enumerate}
