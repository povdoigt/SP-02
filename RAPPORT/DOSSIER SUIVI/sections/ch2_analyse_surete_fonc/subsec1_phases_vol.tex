...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item FTP1-FTP4\cite[p. ~84-86]{CDC_BiEtage} : système de démarage de la chronométrie prêt et conforme.
    \end{itemize}
...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Règles du \acrshort{CDC} ASF2 concernées} : (pas de règle spécifique à cette phase décrit par la rubrique ASF
    du \acrshort{CDC})
