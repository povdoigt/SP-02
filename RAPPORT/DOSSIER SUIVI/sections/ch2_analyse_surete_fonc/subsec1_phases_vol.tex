...
\begin{itemize}
    ...
    \item \textbf{Règles du CDC ASF2 concernées} :
    \begin{itemize}
        \item MAF1-MAF8 : L'accélération subie ne doit pas compromettre le système d'allumage.
        \item INF1-INF3 : L'accélération subie ne doit pas compromettre le fonctionnement de l'inflammateur.
        \item ORDRE2, ORDRE4 : mesure du temps depuis l’allumage du moteur du 1er étage.
        \item ATT1-ATT4 : L'accélération subie ne doit pas compromettre le système de vérification d’attitude du 2nd étage.
        \item FTP1-FTP4 : fenêtre temporelle de vol du 1er étage fonctionnelle.
        \item SEP1-SEP3 : L'accélération subie ne doit pas compromettre le système de détection de séparation.
    \end{itemize}
