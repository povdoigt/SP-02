...
% \hline
% Règles & Type 2 & Détails du \acrshort{CDC} \\ \hline
...
% La contrainte imposée par le \acrshort{CDC} est une vitesse de redescente comprise entre 5 et 15m/s pour les trois configurations (étage 1, étage 2 et non séparé).
