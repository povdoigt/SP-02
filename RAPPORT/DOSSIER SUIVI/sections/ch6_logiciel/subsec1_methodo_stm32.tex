...
\begin{minipage}{0.55\textwidth}  
    \begin{figure}[H]
        \centering
        \includegraphics[width=\textwidth]{figures/elec/chaine_compilation_stm32.drawio.pdf}
...
\begin{minipage}{0.30\textwidth}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.4\textwidth]{figures/elec/superloop.drawio.pdf}
...
\begin{minipage}{0.35\textwidth}
    \begin{figure}[H]
        \centering
        \includegraphics[width=\textwidth]{figures/elec/rtos.drawio.pdf}
