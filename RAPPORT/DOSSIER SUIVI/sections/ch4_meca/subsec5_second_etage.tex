...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/meca/catia_beta.png}
    \caption{Vue de la structure du second étage sur \acrshort{CATIA}}
    \label{fig:structure_second_etage}
\end{figure}
