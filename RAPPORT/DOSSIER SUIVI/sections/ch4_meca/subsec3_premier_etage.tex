...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}
        ...
        \node (P_lbl)  at (-0.60, +1.000) {\textbf{P}};
        \node (F_lbl)  at (+4.50, +1.000) {\textbf{F}};

        \draw[red, <-, line width=1] (-7.200, +0.5) -- (-7.200, +0.0);
        \draw[red, <-, line width=1] (x_lbl.north)  -- (-7.200, +0.0);
        \draw[red, ->, line width=1] (+4.245, +1.0) -- (+4.245, +0.3);
        \draw[red, ->, line width=1] (-0.955, +1.0) -- (-0.955, +0.3);
        \draw[red, ->] (-6.7, 0) arc (0:90:.5cm);
        \draw [<->, > = stealth, black] (-7.2, -0.75) -- (-0.955, -0.75) node [midway, fill = white] {0,880m} ;
        \draw [<->, > = stealth, black] (-7.2, -1.25) -- (+6.100, -1.25) node [midway, fill = white] {1,800m} ;
    \end{tikzpicture}
...
Notre estimation de masse étant approximative, nous avons décidé d’arrondir la charge $m_{test}$ à $10kg$.
