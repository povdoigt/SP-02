...
À la suite de la conception, nous avons pu réaliser les tubes de la strcuture porteuse de la fusée. Nous avons procédé à un test
...
avons encastré le tube comme si tenu par le propulseur et réalisé les tests comme au C'Space. 
\begin{table}[h!]
\centering
\begin{tabular}{|c|c|c|}
\hline
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/schema1_SP-01.PNG}
...
\subsubsection{Aérofrein}
La place disponible dans le premier étage étant très limitée, nous avons opté pour un aérofrein de type "plaque déployable".
Le système est composé de deux bagues en aluminium 7075 de 7 mm d'épaisseur et du même diamètre que l'intérieur du fuselage.
Entre les deux plaques, un système de bièles permet de déployer les aérofreins à l'aide d'un servo-moteur.
...
Les aérofreins à proprement parler sont constitués de plaques en aluminium 7075 de 7 mm d'épaisseur fixés entre les deux bagues
