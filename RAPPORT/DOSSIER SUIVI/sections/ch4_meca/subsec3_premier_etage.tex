...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.55\textwidth]{figures/schema3_SP-01.PNG}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.3\textwidth} % Réduire légèrement pour éviter le débordement
        \centering
        \includegraphics[width=\linewidth]{figures/rerian_brut.jpg}
        \caption{Rérain brut après démoulage} % Ajoute une légende si nécessaire
        \label{fig:maintien3}
    \end{subfigure}
    \begin{subfigure}{0.3\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/rerain.jpg}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.5\textwidth]{figures/tube_propu.jpg}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.27\textwidth} % Réduire légèrement pour éviter le débordement
        \centering
        \includegraphics[width=\linewidth]{figures/bloc_propu_vue_coupe.png}
        \caption{Vue de coupe} % Ajoute une légende si nécessaire
        \label{fig:maintien3}
    \end{subfigure}
    \begin{subfigure}{0.27\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/bloc_propu_vue_face.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.38\textwidth} % Réduire légèrement pour éviter le débordement
        \centering
        \includegraphics[width=\linewidth]{figures/maintien3_pro54.png}
        \caption{Vue de dessous} % Ajoute une légende si nécessaire
        \label{fig:maintien3}
    \end{subfigure}
    \begin{subfigure}{0.38\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/maintien4_pro54.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.26\textwidth} % Réduire légèrement pour éviter le débordement
        \centering
        \includegraphics[width=\linewidth]{figures/para_etage1-1.png}
        \caption{Position verrouillée}
        \label{fig:para_etage1-1}
    \end{subfigure}
    \begin{subfigure}{0.26\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/para_etage1-2.png}
        \caption{Servomoteur à mi-course}
        \label{fig:para_etage1-2}
    \end{subfigure}
    \begin{subfigure}{0.26\textwidth} % Réduire légèrement pour éviter le débordement
        \centering
        \includegraphics[width=\linewidth]{figures/para_etage1-3.png}
...
\label{subsec:bloc_elec1}

L'intégration de l'électronique est regroupée dans le bloc suivant et se compose des éléments vitaux de la fusée. Nous avons opté pour cette configuration car elle permet d'opérer sur l'entièreté des cartes de l'étages sur une seule section tout en facilitant la sortie des batteries de la fusée. Seuls les 2 vis de ce bloc contraingent tout mouvement des batteries dans le bloc et sont dévissables depuis l'intérieur de la fusée sans avoir besoin de retirer le bloc.
De plus, nous intégrons les connections des deux caméras de l'étage, les cartes de télémesure et le séquenceur capable de lancer et communiquer avec l'étage supérieur pour actionner le système de séparation.
L'entièreté des 6 cartes (séquenceur, interface IHF, APEX, APEX-EX, PCB Caméra, Carte Routeur), 4 Batteries, 1 caméra et un servomoteur sont regroupés dans un bloc de 100mm de diamètre sur 15cm.
\begin{figure}[H]
    \centering
    \begin{subfigure}{0.35\textwidth} % Réduire légèrement pour éviter le débordement
        \centering
        \includegraphics[width=\linewidth]{figures/bloc_elec1-1.png}
        \caption{Vue isométrique}
        \label{fig:elec_etage1-1}
    \end{subfigure}
    \begin{subfigure}{0.35\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/bloc_elec1-2.png}
        \caption{Vue opposée de la vue isométrique}
