...
\definecolor{green2}{RGB}{100, 240, 50}
...
\title{
    \Huge \textbf{SP - 02} \\
<<<<<<< HEAD:RAPPORT/DOSSIER SUIVI/DossierSuivi_SP02.tex
    \large Projet de fusée bi-étage AéroIPSA 2025-2026 \\
    \large Document de fin de projet\\
=======
    \large Fusée bi-étage AéroIPSA 2025-2026 \\
    \large Rapport de projet\\
>>>>>>> ALEXIS:RAPPORT/DOSSIER SUIVI/RapportProjet_SP02.tex
}
...
\def\@maketitle{
    ...
    \begin{tabular}{>{\raggedright\arraybackslash}m{0.5\textwidth}
        ...
        \vspace{-1.8cm}\includegraphics[width=0.3\textwidth]{figures/Logo_SP-02.png}
        & \vspace{-1.8cm}\includegraphics[width=0.3\textwidth]{figures/AEROIPSA.png}
    \end{tabular}
    ...
    \begin{figure}[h]
        \centering
        \rotatebox{-75}{
            \includegraphics[width=1.05\textwidth]{figures/meca/SP_Finish.png}
            %\includegraphics[width=0.27\textwidth]{figures/meca/SP_MaJ_1.png} Angle = 15
        }
    ...
    \begin{tabular}{>{\raggedright\arraybackslash}m{0.5\textwidth}
        ...
        \hspace{1cm} - PICHON Lucas     & \\
<<<<<<< HEAD:RAPPORT/DOSSIER SUIVI/DossierSuivi_SP02.tex
        \hspace{1cm} - LE CAM Maxens    & \\
        \hspace{1cm} - PEIX Guillaume   & Août 2026 \\
=======
        \hspace{1cm} - LE CAM Maxens    & Août 2026 \\
>>>>>>> ALEXIS:RAPPORT/DOSSIER SUIVI/RapportProjet_SP02.tex
        \hline
    \end{tabular}
}
...
\input{sections/ch1_generalites/main.tex}
\input{sections/ch2_profile_vol/main.tex}
\input{sections/ch3_analyse_surete_fonc/main.tex}
\input{sections/ch4_meca/main.tex}
\input{sections/ch5_elec/main.tex}
\input{sections/ch6_logiciel/main.tex}
\input{sections/ch7_campagne_lancement/main.tex}
\input{sections/ch8_retour_experience/main.tex}
\input{sections/mots_de_fin.tex}
...
\addcontentsline{toc}{section}{\protect\numberline{}Glossaire et acronymes}
