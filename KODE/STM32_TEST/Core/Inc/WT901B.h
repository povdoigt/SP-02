 ...
 * the datasheet【522002904479991†L1658-L1672】【522002904479991†L1689-L1702】.
 */
 ...
 * positioning accuracy frame【522002904479991†L1600-L1642】.
 */
 ...
 * 10 Hz update rate【522002904479991†L1658-L1672】. Note that some product
 * variants support extended rates such as 500 Hz/1000 Hz (codes 0x0C and
 ...
 */
/** Acceleration scale (g per LSB). Formula: raw/32768*16 g【522002904479991†L866-L899】 */
#define WT901B_ACCEL_SCALE_G        (16.0f / 32768.0f)
/** Gyroscope scale (°/s per LSB). Formula: raw/32768*2000 °/s【522002904479991†L931-L956】 */
#define WT901B_GYRO_SCALE_DPS       (2000.0f / 32768.0f)
/** Angle scale (° per LSB). Formula: raw/32768*180 °【522002904479991†L987-L1014】 */
#define WT901B_ANGLE_SCALE_DEG      (180.0f / 32768.0f)
/** Temperature scale (°C per LSB). Formula: raw/100 °C【522002904479991†L903-L909】 */
#define WT901B_TEMPERATURE_SCALE_C  (1.0f / 100.0f)
/** Quaternion scale (dimensionless per LSB). Formula: raw/32768【522002904479991†L1332-L1353】 */
#define WT901B_QUATERNION_SCALE     (1.0f / 32768.0f)
/** GPS altitude scale (m per LSB). Formula: raw/10 m【522002904479991†L1256-L1264】 */
#define WT901B_GPS_ALTITUDE_SCALE_M (1.0f / 10.0f)
/** GPS heading scale (° per LSB). Formula: raw/100 °【522002904479991†L1271-L1277】 */
#define WT901B_GPS_HEADING_SCALE_DEG (1.0f / 100.0f)
/** GPS speed scale (km/h per LSB). Formula: raw/1000 km/h【522002904479991†L1288-L1291】 */
#define WT901B_GPS_SPEED_SCALE_KMH  (1.0f / 1000.0f)
/** PDOP/HDOP/VDOP scale (dimensionless per LSB). Formula: raw/100【522002904479991†L1387-L1417】 */
...
typedef struct WT901B_t {
    ...
    uint8_t frame_buf[WT901B_FRAME_LENGTH * WT901B_FRAME_TYPE_NBR]; /**< Temporary buffer for one 11‑byte frame */
    uint8_t new_data_nbr;        /**< Number of new frames available in the buffer */
