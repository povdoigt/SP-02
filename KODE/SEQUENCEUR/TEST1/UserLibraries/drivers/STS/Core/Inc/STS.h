...
#define STS_REG_MOVMENT_SPEED_THRESHOLD	0x50    // Movement speed threshold
#define STS_REG_DTS						0x51    // in (ms)
#define STS_REG_SPEED_UNIT_COEF			0x52    // Speed unit coefficient
#define STS_REG_MIN_SPEED_LIMIT			0x53    // Minimum speed limit (in 0.732 RPM)
#define STS_REG_MAX_SPEED_LIMIT			0x54    // Maximum speed limit (in 0.732 RPM)
...
extern STS_UART_Port_t huart_sts_port2;
