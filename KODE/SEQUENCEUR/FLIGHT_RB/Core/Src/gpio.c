...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LED1R_Pin|LED1B_Pin|LED1G_Pin|OUT_N2_Pin
                          |OUT_N3_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : STAGE1_Pin */
  GPIO_InitStruct.Pin = STAGE1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(STAGE1_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : STAGE2_Pin */
  GPIO_InitStruct.Pin = STAGE2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(STAGE2_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : PRGM3_Pin PRGM_RUN_Pin */
  GPIO_InitStruct.Pin = PRGM3_Pin|PRGM_RUN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
