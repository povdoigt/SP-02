...
#define WT901B_RX_BUFFER_SIZE       (WT901B_FRAME_READ_LENGTH * WT901B_FRAME_TYPE_NBR)  /**< Size of the receive buffer */
...
typedef struct WT901B_t {
    ...
    uint8_t *parse_buffer;  /**< Buffer for assembling incoming frames */
