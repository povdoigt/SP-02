...
\begin{figure}[H]
    \centering
    % \includegraphics[width=0.92\textwidth]{figures/apex_bes/fig_04.png}
    \caption{%
    % CAPTION À COPIER-COLLER du rapport APEX BES (Figure 4)
    }
...
\begin{figure}[H]
    \centering
    % \includegraphics[width=0.92\textwidth]{figures/apex_bes/fig_05.png}
    \caption{%
    % CAPTION À COPIER-COLLER du rapport APEX BES (Figure 5)
    }
    \label{fig:apex_bes_fig05}
\end{figure}
