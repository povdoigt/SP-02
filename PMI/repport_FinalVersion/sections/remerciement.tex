...
Nous remercions Maxence Fulconis, \gls{Skylab} Manager de l’\acrshort{IPSA}, pour l’accès aux moyens de fabrication et pour
nous avoir permis d’usiner nos pièces à la \acrshort{CNC} dans de bonnes conditions. Nous remercions également les anciens
d’AéroIPSA, en particulier Vincent Fauquembergue pour la transmission de savoir-faire pratique, ainsi que l’ensemble des
membres impliqués dans le projet au sein de l’association, qui ont contribué aux différentes réalisations.\\

Nous remercions aussi le \acrshort{CNES} et \gls{Planète Sciences} pour leur cadrage et leurs conseils. Les échanges et
recommandations, ainsi que le cahier des charges associé, ont permis de définir des limites réalistes au projet et de guider
les choix de conception, avec l’appui de retours techniques apportés lors des points de suivi.\\
