...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1\textwidth]{figures/Schema_simple.drawio.png}
...
Le projet APEX correspond à une plateforme électronique développée au sein de l’association AéroIPSA afin de fournir une
solution générique et réutilisable pour l’acquisition de données, la gestion temporelle des mesures et la télécommunication dans
le cadre de projets de fusées expérimentales. Son développement a débuté l’année précédente, avec pour objectif de disposer
d’une architecture modulaire, robuste et adaptée aux contraintes d'un vol de fusée expérimentale.\\

APEX s’inscrit dans la continuité d’un projet plus ancien, nommé \emph{Unknown}\cite{Projet_Unknown}, qui constituait une
première tentative de centralisation des fonctions d’acquisition et de communication embarquées. Les retours d’expérience issus
de ce projet ont permis d’orienter la conception d’APEX vers une architecture plus structurée, mieux instrumentée et pensée dès
l’origine pour la synchronisation temporelle des données et l’intégration de multiples capteurs dans le but d'un vecteur
d'expérience multi-étages.\\
