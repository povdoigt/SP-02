...
\title{
    \huge \textbf{ET2 - Perspective d’expérience d’un système de séparation d’étages de fusée par aérofreinage} \\
    \large \acrlong{PMI} \\
...
\def\@maketitle{
    ...
    \begin{tabular}{>{\raggedright\arraybackslash}m{0.5\textwidth}
        ...
        \hspace{1cm} - PEIX Guillaum   & \\
        \hspace{1cm} - PICHON Lucas    & Janvier 2025 \\
        \hline
    \end{tabular}
}
\makeatother
