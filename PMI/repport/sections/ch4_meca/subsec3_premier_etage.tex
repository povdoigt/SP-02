...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/maintien2_pro54.png}
...
\subsubsubsection{Définition du système d'aérofreins}
...
\begin{figure}[h!]
    \centering
    \begin{tikzpicture}
        \node at (0, 0) {\includegraphics[width=\textwidth]{figures/Schema_AF.jpg}};
        ...
        \filldraw[white, opacity=0.6] (-1, -4.5) rectangle (8, 4.5);
        ...
        \node (AA) at (0.405, 0.955) {};
        \node (AA_lbl) at (0.25, 0.75) {\textbf{A}};

        \node (BA) at (2.965, 1.94) {};
        \node (BA_lbl) at (3.25, 2.25) {\textbf{B}};

        \draw[circle, dotted, line width=1.5] (OA) circle (1.1405);
        ...
        \draw (1.3, 1.94) arc (0:-120:0.3cm) node [midway, right] {\textbf{$\theta$}};


        \node (OB) at (0.965, -1.97) {};
        \node (OB_lbl) at (0.75, -1.75) {\textbf{O}};

        \node (AB) at (2.11, -1.97) {};
        \node (AB_lbl) at (2.5, -1.5) {\textbf{A}};

        \node (BB) at (4.845, -1.97) {};
        \node (BB_lbl) at (5.15, -1.75) {\textbf{B}};

        \draw[circle, dotted, line width=1.5] (OB) circle (1.145);
        ...
        \draw[line width=1.5, <->] (5.4, -3.8) -- (7.4, -3.8) node [midway, below] {\textbf{D}};
...
\begin{equation}
    \boxed{D = R \cos(\theta) + \sqrt{L^2 - R^2 \sin^2(\theta)} - R_{fusee}}
\end{equation}

\subsubsubsection{Simulation de résistance mécanique des aérofreins}

\newpage

\subsubsubsection{Performance aérodynamique des aérofreins}
