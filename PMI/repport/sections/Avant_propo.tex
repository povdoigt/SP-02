...
Ce document remplit ainsi plusieurs fonctions complémentaires. D'une part, il constitue un support d'échange et d'évaluation à
...
Ainsi, les différentes sections du document participent soit :
\begin{itemize}
...
\end{itemize}
sans que ces deux dimensions ne soient dissociées. Le choix a été fait de conserver un document unique, garantissant une vision
cohérente et réaliste du projet, à la fois sur le plan technique, organisationnel et académique.\\
...
et suieurs de \gls{Planète Sciences}, ainsi que les membres actuels et futurs de l'association AéroIPSA, chacun pouvant y trouver
