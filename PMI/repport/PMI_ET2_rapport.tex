...
\title{
    \huge \textbf{ET2} : Perspective d'expérience d'un système de séparation d'étages de fusée par
    aérofreinage \\ \vspace{0.2cm}
    \large Projet \textbf{SP-02}, fusée bi-étage, AéroIPSA 2025-2026 \\
}
...
\def\@maketitle{
    ...
    \begin{tabular}{>{\raggedright\arraybackslash}m{0.5\textwidth}
        ...
        \vspace{-2cm}\includegraphics[width=0.3\textwidth]{figures/IPSA_LOGO_SS-BASELINE-2021_NOIR.png} &
    ...
    \begin{tabular}{m{0.6\textwidth}>{\raggedleft\arraybackslash}m{0.4\textwidth}}
        \acrlong{IPSA} & AéroIPSA \\
        63 bvd de Brandbourg & 63 bvd de Brandbourg \\
        94200 Ivry-sur-Seine & 94200 Ivry-sur-Seine
    \end{tabular}
    \end{center}
    \begin{flushright}
        {\rule{\larg}{1mm}}\\
    ...
    \begin{figure}[h]
        \centering
        \rotatebox{-75}{
            \includegraphics[width=1\textwidth]{figures/catia_alpha_beta.png}
        }
    ...
    \begin{tabular}{>{\raggedright\arraybackslash}m{0.5\textwidth}
        ...
        \hspace{1cm} - PEIX Guillaume   & \\
        Tuteur :                        & \\
        \hspace{1cm} - ABASSI Wafik     & Janvier 2025 \\
        \hline
    \end{tabular}
}
\makeatother
...
\input{sections/Avant_propo.tex}

\newpage
\tableofcontents
\newpage

\input{sections/synthese.tex}
\input{sections/Introduction.tex}
\input{sections/ch1_generalites/main.tex}
\input{sections/ch2_analyse_surete_fonc/main.tex}
\input{sections/ch3_stabilite_gabarits/main.tex}
\input{sections/ch4_meca/main.tex}
\input{sections/ch5_elec/main.tex}
\input{sections/ch6_experience/main.tex}
% \input{sections/ch5_tests_et_validations/main.tex}
